...
// <ContainerMessage position="top_left">
//   <Message position="top_left" type="info" time={5}>Disciplina vinculada com sucesso!</Message>
//   <Message position="top_left" type="info" time={10}>Disciplina vinculada com sucesso!</Message>
// </ContainerMessage>

// <ContainerMessage position="bottom_right">
//   <Message position="bottom_right" type="error" time={5} >Disciplina vinculada com sucesso!</Message>
//   <Message position="bottom_right" type="error" time={10} >Disciplina vinculada com sucesso!</Message>
// </ContainerMessage>

// <ContainerMessage position="bottom_left">
//   <Message position="bottom_left" type="warning" time={5} > Disciplina vinculada com sucesso!</Message>
//   <Message position="bottom_left" type="warning" time={10} > Disciplina vinculada com sucesso!</Message>
// </ContainerMessage>
  ...
  useEffect(() => {
    ...
    type === "success" ? (
      setMessage((prevState) => ({ ...prevState, image: "/checkCircle.svg" })),
      setMessage((prevState) => ({ ...prevState, alt: "icone de sucesso" })),
      setMessage((prevState) => ({ ...prevState, closeImage: "/close.svg" })),
      setMessage((prevState) => ({ ...prevState, closeAlt: "Ícone de fechar" })),
      setCor("#28A34D;")) : "" //cor da barra de progresso

    type === "info" ? (
      setMessage((prevState) => ({ ...prevState, image: "/info.svg" })),
    ...
    type === "error" ? (
      setMessage((prevState) => ({ ...prevState, image: "/error.svg" })),
    ...
    type === "warning" ? (
      setMessage((prevState) => ({ ...prevState, image: "/warning.svg" })),
      setMessage((prevState) => ({ ...prevState, alt: "icone de aviso" })),
      setMessage((prevState) => ({ ...prevState, closeImage: "/closeBlack.svg" })),
